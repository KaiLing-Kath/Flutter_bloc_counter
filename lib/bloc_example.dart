  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<CounterCubit, int >(
        bloc: cubit,
        listener: (context, state) {
          const snackbar = SnackBar(content: Text('Congrats!! State is reached!!'),
          );
          if(state == 5) {
            ScaffoldMessenger.of(context).showSnackBar(snackbar);
          }
        ...
        builder: (context, state) {
          return Center(
            child: Column(
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Text('$state', style: TextStyle(fontSize: 100),),
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      ElevatedButton(onPressed: () {cubit.increment();},
                        style: ElevatedButton.styleFrom(primary: Colors.green, padding:EdgeInsets.all(12)),
                        child: const Text('Increment', style: TextStyle(fontSize: 15)),
                      ),
                      ElevatedButton(onPressed: () {cubit.decrement();},
                        style: ElevatedButton.styleFrom(primary: Colors.red, padding:EdgeInsets.all(12)),
                        child: const Text('Decrement', style: TextStyle(fontSize: 15,),),
                      ),
                      ElevatedButton(onPressed: () {cubit.reset();},
                        style: ElevatedButton.styleFrom(primary: Colors.pink, padding:EdgeInsets.all(12)),
